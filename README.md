...
| [Generate CPID](apis/service-providers/cpid) | [Notification API](apis/operators/notification)<br />[Rich notification API](apis/service-providers/rich-notifications) | Data Feedback Loop (TBA) |
